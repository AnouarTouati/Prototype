...
public class CarCam : MonoBehaviour
{
   ...
   // Transform carCam;
    ...
    public bool LastFrameisDeadValue=false;
    ...
    void Start()
    {
        if (!GetComponentInParent<IdentityFlag>().photonView.IsMine||GetComponentInParent<Motor>().AIDriving)
        {
    ...
    void FixedUpdate()
    {
       if(rootNode!=null && car!=null && carPhysics != null)
        {
            Quaternion look;
